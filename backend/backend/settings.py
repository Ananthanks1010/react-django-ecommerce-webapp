...
SECRET_KEY = 'django-insecure--dc^8w8@-ip^=u7n(xzd44ko=*e7(-tn(%yvx1(bz@p4y&mjv9'
...
AWS_COGNITO_REGION = os.getenv("AWS_REGION_NAME")
...
COGNITO_CLIENT_SECRET = os.getenv("AWS_CLIENT_SECRET")
